...
public class HudBleManager {
    private static HudBleManager bleManager;
    private BluetoothGattServiceDao bluetoothGattServiceDao;

    private HudBleManager(){

    }

    public static HudBleManager getInstance(){
        if(null==bleManager){
            synchronized (HudBleManager.class){
                if(null==bleManager){
                    bleManager=new HudBleManager();
                }
            }
        }
        return bleManager;
